...
$like_stmt = oci_parse($con, "SELECT poszt.id, COUNT(*) as like_count FROM likes, poszt WHERE likes.poszt_id = poszt.id GROUP BY poszt.id");
$like_count = [];
